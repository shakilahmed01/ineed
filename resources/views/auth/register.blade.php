            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="card_name" class="col-md-4 col-form-label text-md-right">{{ __('Card Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="card_quantity" class="col-md-4 col-form-label text-md-right">{{ __('Card Quantity') }}</label>

                            <div class="col-md-6">
                                <input id="card_quantity" type="text" class="form-control @error('card_quantity') is-invalid @enderror" name="card_quantity" value="{{ old('card_name') }}" required autocomplete="card_quantity" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="account" class="col-md-4 col-form-label text-md-right">{{ __('Discount') }}</label>
