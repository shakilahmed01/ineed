...
<section class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Offer Update') }}</div>

                <div class="body">

                <form  method="POST" action="{{route('offer_update')}}" enctype="multipart/form-data">
                     @csrf
                   ...
                   <label for="store_name">Store Name</label>
                        ...
                        <div class="form-group form-float">
                          <label for="phone">Discount</label>
                            <input type="text" class="form-control"  name="discount" value="{{$list->discount}}" required>
                        </div>
